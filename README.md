...
Getting started with FloWealth is simple. Here's the flow:

**1. Create a Theme** 🏷️
First, create a theme to organize your expenses. Themes are color-coded categories like "Groceries", "Electronics", or "Food".

**2. Create a Note** 📝
Add a new note under your theme. Write what you plan to buy — either manually add products or use the AI prompt feature to type in natural language.

**3. Complete Your Shopping** ✅
When you're done shopping, mark your note as completed. You can also upload a receipt and let AI analyze it to fill in actual prices.

**4. Compare & Analyze** 🤖
Use AI-powered tools to compare your planned expenses vs actual spending, get insights, and track your spending patterns over time.
