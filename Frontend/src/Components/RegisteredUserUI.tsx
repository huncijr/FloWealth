  ...
  return (
    <div className="p-10 sm:p-20 flex flex-col registeredui-slidefade registeredui-slidefade-stagger">
      ...
      <div className="mt-10 pr-4">
        ...
        >
          <Tabs.ListContainer
            className={`p-3 rounded-xl px-2 ${isSmUp ? "overflow-x-auto" : "overflow-x-auto "}`}
          >
            <Tabs.List
            ...
            >
              <Tabs.Tab
                id="account"
                className=" justify-center sm:justify-start  sm:gap-2 px-6 sm:px-4 py-6 sm:py-3 rounded-lg mb-3
              ...
              <Tabs.Tab
                id="tokens"
                className="justify-center sm:justify-start gap-3 sm:gap-2 px-6 sm:px-4 py-6 sm:py-3 rounded-lg mb-3
                   bg-content1 hover:bg-secondary/30 bg-gray-300 dark:bg-gray-900 
          ...
          <Tabs.Panel id="account" className="flex-1 p-6 rounded-xl">
            <div className="flex flex-col items-center gap-4">
              {/* Avatar - nagyobb, szebb */}
              <Avatar size="lg" className="w-28 h-28 ring-2 ring-secondary/50">
                {user?.picture ? (
        ...
        ${user?.isGoogleUser ? "bg-blue-100 text-blue-600" : "bg-gray-100 text-gray-600"}`}
          ...
          <Tabs.Panel id="feedback" className="p-6">
            <div className="flex mb-5 justify-center items-center gap-2">
              <Sparkles className="w-6 h-6 text-primary" />
              <h3 className="text-xl font-bold">Contact Us</h3>
            </div>
            <div
              className=" grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 items-stretch w-full
  "
            >
              {/* Bug Report Card */}
      ...
      "
              ...
              <Card
                ...
                onClick={() =>
                  window.open("https://github.com/huncijr/FloWealth", "_blank")
                }
              >
                <Card.Header
                  className="grid grid-cols-[auto,1fr] sm:grid-cols-[auto,1fr,auto] items-center  gap-4   p-4 w-full
      "
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm break-words">github.com/huncijr</p>
                  </div>
      ...
      "
                >
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold">Have an Issue or an Idea ?</p>
